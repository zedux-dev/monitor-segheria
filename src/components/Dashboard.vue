    ...
    methods: {
        newTaglio(secondi) {
            if(this.enabled) {
                ...
                if(this.currentTaglio.cliente == "") cliente = "Senza nome";

                if(this.database.tagli[cliente] == undefined) this.database.tagli[cliente] = {};
                
                let now = new Date();
                
                let formattedDate = String(now.getDate()).padStart(2, '0') + "/" + String(now.getMonth()+1).padStart(2, '0') + "/" + now.getFullYear();
                ...
                this.currentTaglio.data = String(now.getDate()).padStart(2, '0') + "/" + String(now.getMonth()+1).padStart(2, '0') + "/" + now.getFullYear();
