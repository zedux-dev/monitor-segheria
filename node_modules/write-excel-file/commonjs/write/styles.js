...
function generateXml(_ref4) {
  ...
  for (var _iterator4 = _createForOfIteratorHelperLoose(styles), _step4; !(_step4 = _iterator4()).done;) {
    ...
    align || alignVertical || textRotation || indent || wrap ? '<alignment' + (align ? " horizontal=\"".concat((0, _sanitizeAttributeValue["default"])(align), "\"") : '') + (alignVertical ? " vertical=\"".concat((0, _sanitizeAttributeValue["default"])(alignVertical), "\"") : '') + (textRotation ? " textRotation=\"".concat(getTextRotation(validateTextRotation(textRotation)), "\"") : '') + (indent ? " indent=\"".concat((0, _sanitizeAttributeValue["default"])(String(indent)), "\"") : '') + (wrap ? " wrapText=\"1\"" : '') + '/>' : '') + '</xf>';
  }
